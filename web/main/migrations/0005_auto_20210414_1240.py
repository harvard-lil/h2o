...
def recreate_search_index(apps, schema_editor):
    # Today's search SQL uses columns added later; fresh installs need this historical snapshot.
    schema_editor.execute(Path(__file__).with_name("0005_search_index.sql").read_text())
