H2o::Application.configure do
  ...
  config.assets.precompile += %w( application-print.css application-print.js print.css )
  ...
  config.middleware.use ExceptionNotification::Rack,
    ...
    :email => {
      ...
      :exception_recipients => %w{bgadoury@endpoint.com} #later add h2o@cyber.law.harvard.edu tim@endpoint.com
    }
end
