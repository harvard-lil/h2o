class CreateQuestions < ActiveRecord::Migration
  def self.up
    ...
    add_index :questions, [:question_instance_id, :position], :unique => true, :name => 'unique_in_question_instance'
    add_index :questions, [:user_id,:question_instance_id, :position], :unique => true, :name => 'unique_user_in_question_instance'
  end
