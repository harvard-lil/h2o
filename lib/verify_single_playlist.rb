class VerifySinglePlaylist
  attr_accessor :casebook, :playlist, :mismatched, :object, :item, :resource, :section
  ...
  def loop_playlist_items(playlist_items, path:)
    ...
    def bad_item_or_resource?
      resource.nil? || item.nil? || object.nil? || item.actual_object_type == "Migrate::Media" || object.annotatable.nil?
