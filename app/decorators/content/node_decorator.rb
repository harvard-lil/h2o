class Content::NodeDecorator < Draper::Decorator
  ...
  def section_draft
    ...
    link_to(I18n.t('content.actions.export'), export_section_path(section), class: 'action one-line export')
  end
  ...
  def resource_draft
    if action_name == 'edit'
      ...
      link_to(I18n.t('content.actions.export'), export_resource_path(resource), class: 'action one-line export')
    else
      link_to(I18n.t('content.actions.preview'), resource_path(casebook, resource), class: 'action one-line preview') +
      link_to(I18n.t('content.actions.export'), export_resource_path(resource), class: 'action one-line export')
    end
