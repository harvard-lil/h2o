...
class CollageSweeper < ActionController::Caching::Sweeper
  ...
  def after_save(record)
    ...
    expire_fragment("collage-annotation-print-content-#{record.id}")
    ...
    record.path_ids.each do |path_id|
      ...
      expire_fragment("collage-annotation-print-content-#{path_id}")
    ...
    record.descendant_ids.each do |descendant_id|
      ...
      expire_fragment("collage-annotation-print-content-#{descendant_id}")
    ...
    record.sibling_ids.each do |sibling_id|
      ...
      expire_fragment("collage-annotation-print-content-#{sibling_id}")
