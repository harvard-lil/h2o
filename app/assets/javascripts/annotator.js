...
NullStore = _dereq_('./plugin/nullstore');
...
Annotator = (function(_super) {
  ...
  Annotator.prototype.onHighlightMouseover = function(event) {
    ...
    if(annotation.id !== undefined && $('#annotation-indicator-' + annotation.id).size() > 0) {
      var viewer_position = { top: $('#annotation-indicator-' + annotation.id).position().top + 13, right: 0 };
      return this.showViewer([annotation], viewer_position);
    }
  };
  ...
  Annotator.prototype.onAdderClick = function(event) {
    ...
    //H2O Customization - avoiding create on update
    if(this.selectedRanges === null || this.selectedRanges.length == 0) {
      return;
    }
...
},{"./annotations":5,"./delegator":7,"./editor":8,"./factory":9,"./notification":10,"./plugin":11,"./plugin/nullstore":12,"./range":13,"./util":14,"./viewer":15,"./widget":16,"backbone-extend-standalone":3}],7:[function(_dereq_,module,exports){
var $, BackboneEvents, Delegator, _parseEvents,
  __slice = [].slice;
...
},{"./util":14,"backbone-events-standalone":2}],8:[function(_dereq_,module,exports){
...
Editor = (function(_super) {
  ...
  Editor.prototype.show = function(event) {
    ...
    this.element.find('.annotator-save').focus();
  ...
  Editor.prototype.submit = function(event) {
    ...
    if($('.annotator-editor').hasClass('highlight')) {
      var hex = $('.hexes').find('.active');
      if($('input#new_layer').val() != '') {
        if(hex.size() == 0) {
          error_msg = 'Tag must have a color.';
        }
    ...
    if($('.annotator-editor').hasClass('link')) {
      if(!($('input#link').val().match(/^http:\/\//) || $('input#link').val().match(/^https:\/\//))) {
        error_msg = 'Link must contain http:// or https://';
      }
    }
    if(error_msg != '') {
      $('<span>').attr('id', 'layer_error').addClass('error').html(error_msg).prependTo($('.annotator-controls'));
      return;
    }
...
},{"./util":14,"./widget":16}],9:[function(_dereq_,module,exports){
var Factory, extend,
  __slice = [].slice;
...
},{"backbone-extend-standalone":3}],10:[function(_dereq_,module,exports){
...
},{"./delegator":7,"./util":14}],11:[function(_dereq_,module,exports){
var $, Delegator, Plugin, Util, natives, _isCustomEvent,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
Plugin = (function(_super) {
  ...
  Plugin.prototype.pluginInit = function() {
    var event, functionName, _ref, _results;
    if ((this._oldStyleEvents != null) && Object.keys(this._oldStyleEvents)) {
      Util.deprecationWarning("Binding custom events using the events hash is deprecated. If you need to listen to custom events bind explicitly using something like `this.listenTo(this.annotator, ...)`.");
      _ref = this._oldStyleEvents;
      _results = [];
      for (event in _ref) {
        functionName = _ref[event];
        _results.push(this.listenTo(this.annotator, event, this[functionName]));
      }
      return _results;
    }
  };
  ...
  Plugin.prototype._addEvent = function(selector, event, functionName) {
    if (selector === '' && _isCustomEvent(event)) {
      if (this._oldStyleEvents == null) {
        this._oldStyleEvents = {};
      }
      this._oldStyleEvents[event] = functionName;
    } else {
      Plugin.__super__._addEvent.apply(this, arguments);
    }
    return this;
  };

  Plugin.prototype._removeEvent = function(selector, event, functionName) {
    if (selector === '' && _isCustomEvent(event)) {
      this.stopListening(this.annotator, event, this[functionName]);
    } else {
      Plugin.__super__._removeEvent.apply(this, arguments);
    }
    return this;
  };
...
},{"./delegator":7,"./util":14}],12:[function(_dereq_,module,exports){
var $, NullStore, id;
...
Range.NormalizedRange = (function() {
  ...
  NormalizedRange.prototype.serialize = function(root, ignoreSelector) {
    ...
    serialization = function(node, isEnd) {
      ...
      //H2O Customization
      origParent = $(node).parents(":not(.annotator-hl)").eq(0);
      while(!origParent.hasClass('original_content')) {
      ...
      for (_i = 0, _len = nodes.length; _i < _len; _i++) {
        ...
        //H2O Customization
        if(!$(n).parent().is('.layered-ellipsis')) {
...
},{"./util":14,"./xpath":17}],14:[function(_dereq_,module,exports){
...
},{"jquery":4}],15:[function(_dereq_,module,exports){
...
},{"./util":14,"./widget":16}],16:[function(_dereq_,module,exports){
...
},{"./delegator":7,"./util":14}],17:[function(_dereq_,module,exports){
