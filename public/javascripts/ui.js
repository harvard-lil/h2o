...
jQuery.extend({
  ...
  toggleVisibilitySelector: function() {
    if (jQuery('.privacy_toggle').attr("checked") == "checked"){
      ...
      jQuery('#terms_require').html("<p class='inline-hints'>If this item is submitted as a non-public item, other users will not be able to see, copy, or create derivative works from it, unless you change the item's setting to \"Public.\"</p>");
    }
  },
      ...
      open: function(event, ui) {
        ...
        jQuery.toggleVisibilitySelector();
              if (jQuery(this).attr("checked") == "checked"){
                jQuery('#terms_require').html("<div style='text-align: left; padding-left: 100px'>Submitting this item will allow others to see, copy, and create derivative works from this item in accordance with H2O's <a href=\"/p/terms\" target=\"_blank\">Terms of Service</a>.</div>")
              } else {
                jQuery('#terms_require').html("<div style='text-align:left; padding-left: 100px'>If this item is submitted as a non-public item, other users will not be able to see, copy, or create derivative works from it, unless you change the item's setting to \"Public.\"</div>");
              }
            });
