...
(function() {
  ...
  Util.getTextNodes = function(jq) {
    ...
    getTextNodes = function(node) {
      ...
      if (node && node.nodeType !== Node.TEXT_NODE) {
        ...
        //H2O Customization: Skipping paragraph numbering and \n in markup offsets
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      if(annotation.id != 'noid') {
        this.plugins.H2O.setUnlayeredSingle(annotation);
      }
    ...
    Annotator.prototype.arrayCompare = function(a, b) {
    ...
    Annotator.prototype.onHighlightMouseover = function(event) {
      ...
      //H2O customization to compare arrays
      var annotations_arr = $.makeArray(annotations);
      if (this.mouseIsDown || (this.viewer.isShown() && this.arrayCompare(annotations_arr, this.viewer.annotations))) {
        return false;
      }
      return this.showViewer(annotations_arr, Util.mousePosition(event, this.wrapper[0]));
    };
    ...
    Editor.prototype.addField = function(options) {
      ...
      switch (field.type) {
        ...
        case 'h2o_layer_button':
          ...
          break;
        case 'collage_links':
          input = $('<div>').html('<li>Collages Loading</li>');
      }
      ...
      if(field.type == 'collage_links') {
        element.prepend($('<input type="hidden" id="linked_collage_id" />'));
        element.prepend($('<span id="collage_search"><input type="textbox" /><a href="#" id="collage_link_search" class="button">SEARCH</a></span>'));
        element.addClass('annotator-collage_links');
      }
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype.events = {
      ...
      'beforeAnnotationDeleted': 'beforeAnnotationDeleted',
    ...
    Store.prototype._getAnnotations = function() {
      if (this.options.loadFromSearch) {
        ...
        this.annotator.plugins.H2O.setAllUnlayered();
      ...
      if (__indexOf.call(this.annotations, annotation) < 0) {
        ...
        return this._apiRequest('create', annotation, (function(_this) {
          return function(data) {
            ...
            _this.annotator.plugins.H2O.afterCollageCreated(annotation, data);
  ...
  Annotator.Plugin.Filter = (function(_super) {
    ...
    Filter.prototype._setupListeners = function() {
      ...
      events = ['annotationsLoaded', 'annotationCreated', 'annotationUpdated', 'annotationDeleted', 'beforeAnnotationDeleted'];
